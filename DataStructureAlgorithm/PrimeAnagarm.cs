    ...
    internal class PrimeAnagarm
    {
        ...
        public void PrimeNumber()
        {
            for (int i = 2; i < END_INDEX - 1; i++)
            {
                ...
                {
                    prime[i] = i;
                    Console.WriteLine("Prime Number is:" + prime[i]);
                }
            }
        }
            ...
            for (int i = 10; i < END_INDEX - 1; i++)
            {
                ...
                if (prime[i] != 0)
                {
                    ...
                    if (total == prime[i])
                    {
                        ...
                        Console.WriteLine("Palindrome Number is:" + prime[i]);
                    }
                }
            }
        }
            ...
            for (int i = 0; i < palindrome.Length - 1; i++)
            {
                for (int j = 0; j < prime.Length - 1; j++)
                {
                    if (palindrome[i] != 0 && prime[j] != 0)
                    {
                        ...
                        {
                            Console.WriteLine("Anagram Number Is: " + palindrome[i]);
                        }
                    }
                }
            }
